...
export default function OurTeam() {
  ...
  useAnimationFrame(() => {
    const current = x.get();
    const maxScroll = -((280 + 40) * teamMembers.length);
  ...
  return (
    ...
    >
      ...
      >
        Innovative minds, creative thinkers, and tech experts dedicated to
                ...
                <Box
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      ...
                      boxShadow: "0 15px 45px rgba(30,144,255,0.55)",
                    },
                  }}
                />
                    ...
                    <Box
                      sx={{
                        ...
                        "&:hover": {
                          ...
                          boxShadow: "0 8px 25px rgba(30,144,255,0.45)",
                        },
