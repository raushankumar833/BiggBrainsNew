    ...
    >
      ...
      <Box
        sx={{
          ...
          alignItems: "center",
          backgroundImage: `linear-gradient(rgba(10, 25, 41, 0.85), rgba(10, 25, 41, 0.9)), url('https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=2070&q=80')`,
          ...
          "&::before": {
            ...
            bottom: 0,
            background:
              "linear-gradient(45deg, rgba(0, 180, 216, 0.1), rgba(144, 224, 239, 0.05))",
            zIndex: 0,
          },
        }}
      >
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
          ...
          >
            ...
            >
              ...
              remarkable digital experiences. Reach out and let's start the
              conversation.
            </Typography>
          </Box>
        </Container>
      ...
      {/* Form + Contact Section Wrapper Box with responsive direction */}
        ...
        >
          ...
          >
            <Grid
              ...
              sx={{
                width: "100%",
                maxWidth: { xs: 400, sm: 500, md: "none" }, // Mobile/tablet pe constrained width
            ...
            >
                ...
                <Card
                  sx={{
                    ...
                    "&:hover": {
                      ...
                      "& .card-content": { transform: "translateX(5px)" },
                    },
                  }}
                >
                  <Box
                    ...
                    >
                      <Box
                        ...
                        sx={{
                          borderRadius: "14px",
                          background:
                            "linear-gradient(135deg, #1d2d46, #2d3e5d)",
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                      ...
                      <Typography
                        ...
                        sx={{
                          ...
                          background:
                            "linear-gradient(135deg, #1d2d46 0%, #3d5070 100%)",
                          WebkitBackgroundClip: "text",
                          WebkitTextFillColor: "transparent",
                          backgroundClip: "text",
                        }}
              ...
              <Grid item xs={12}>
                ...
                >
                  {/* Social Media Card content same as before */}
                  <Stack
                    direction="row"
                    spacing={1.5}
                    alignItems="center"
            ...
            <Paper
              ...
              sx={{
                ...
                "&:hover": {
                  ...
                  boxShadow:
                    "0 25px 50px rgba(29, 45, 70, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.8)",
                },
                "&::before": {
                  content: '""',
                  position: "absolute",
                  ...
                  height: "100%",
                  background:
                    "radial-gradient(circle at 20% 80%, rgba(29, 45, 70, 0.05) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(61, 80, 112, 0.05) 0%, transparent 50%)",
                  zIndex: 0,
                },
                "&::after": {
                  content: '""',
                  ...
                  height: "3px",
                  background:
                    "linear-gradient(90deg, transparent, #1d2d46, transparent)",
                    ...
                    >
                      <Button
                        ...
                        sx={{
                          ...
                          "&:hover": {
                            background:
                              "linear-gradient(135deg, #3d5070 0%, #1d2d46 100%)",
